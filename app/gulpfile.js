			...
			browserSync.create('producer1').init(
				{
					open      : 'external',
					host      : config.domain,
					startPath : '/?roomId=devel&info=false&_throttleSecret=foo&consume=false',
					server    :
					{
						baseDir : OUTPUT_DIR
					},
			...
			browserSync.create('consumer1').init(
				{
					open      : 'external',
					host      : config.domain,
					startPath : '/?roomId=devel&info=false&_throttleSecret=foo&produce=false',
					server    :
					{
						baseDir : OUTPUT_DIR
					},
			...
			browserSync.create('producer1').init(
				{
					open      : 'external',
					host      : config.domain,
					startPath : '/?roomId=devel:tcp&info=false&_throttleSecret=foo&forceTcp=true&consume=false',
					server    :
					{
						baseDir : OUTPUT_DIR
					},
			...
			browserSync.create('consumer1').init(
				{
					open      : 'external',
					host      : config.domain,
					startPath : '/?roomId=devel:tcp&info=false&_throttleSecret=foo&forceTcp=true&produce=false',
					server    :
					{
						baseDir : OUTPUT_DIR
					},
			...
			browserSync.create('producer1').init(
				{
					open      : 'external',
					host      : config.domain,
					startPath : '/?roomId=devel:vp9&info=false&_throttleSecret=foo&forceVP9=true&svc=L3T3&consume=false',
					server    :
					{
						baseDir : OUTPUT_DIR
					},
			...
			browserSync.create('consumer1').init(
				{
					open      : 'external',
					host      : config.domain,
					startPath : '/?roomId=devel:vp9&info=false&_throttleSecret=foo&forceVP9=true&svc=L3T3&produce=false',
					server    :
					{
						baseDir : OUTPUT_DIR
					},
			...
			browserSync.create('producer1').init(
				{
					open      : 'external',
					host      : config.domain,
					startPath : '/?roomId=devel:h264&info=false&_throttleSecret=foo&forceH264=true&consume=false',
					server    :
					{
						baseDir : OUTPUT_DIR
					},
			...
			browserSync.create('consumer1').init(
				{
					open      : 'external',
					host      : config.domain,
					startPath : '/?roomId=devel:h264&info=false&_throttleSecret=foo&forceH264=true&produce=false',
					server    :
					{
						baseDir : OUTPUT_DIR
					},
